...
#Sample parameters
temp = 298 #K
k_emission = 10**9 #emission lifetime in ps
...
bfrates = [1,0.1,0.01,0]#0.3,0.5,0.7,,0.01,0.1,1
...
laserpwr = 5*10**(-5)#2.6*10**(-8)#0.00015 # mW (0.52 mWinto back of objective 23 #mW)
...
N_A = 6.023*10**23
'''
sim.simulate(filepath, filedir, "sens0akadarksonlyevenlonger", write, analyze, makefig, diffuse, antibunch,
                                ...
                                NA, darkcounts, 0, deadtime, afterpulse, order, 
